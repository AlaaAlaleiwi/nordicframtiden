...
public class TaxTableRow {
  ...
  @Column(name="col_1", nullable=false) private Integer col1;
  @Column(name="col_2", nullable=false) private Integer col2;
  @Column(name="col_3", nullable=false) private Integer col3;
  @Column(name="col_4", nullable=false) private Integer col4;
  @Column(name="col_5", nullable=false) private Integer col5;
  @Column(name="col_6", nullable=false) private Integer col6;
  public Long getId() {
    return id;
  }
